...
const contactMethods = [
  ...
  },
  {
    ...
    link: 'mailto:bhuvan1075@gmail.com',
    username: 'bhuvanesh'
  },
  {
    name: 'LinkedIn',
    ...
    link: 'https://www.linkedin.com/in/bhuvanesh-v-4628282ab',
    username: 'Bhuvanesh V'
  }
];
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {contactMethods.map((method, index) => (
              <motion.a
                ...
                className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-lg rounded-xl shadow-lg hover:shadow-xl transition-all"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
